...
CREATE TABLE IF NOT EXISTS `messenger_bot` (
  ...
  `template_type` enum('text','image','audio','video','file','quick reply','text with buttons','generic template','carousel','media','One Time Notification','User Input Flow') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
...
(5, 'Comment Automation', 'fab fa-facebook-square', '', 17, '80,201,202,204,206,220,222,223,251,256', '1', '0', '0', 0, '0', 'Comment Feature', '0', 0),
...
INSERT INTO `menu` (`id`, `name`, `icon`, `url`, `serial`, `module_access`, `have_child`, `only_admin`, `only_member`, `add_ons_id`, `is_external`, `header_text`, `is_menu_manager`, `custom_page_id`) VALUES (14, 'Comment Automation', 'fab fa-instagram', '', 17, '278,279', '1', '0', '0', '0', '0', '', '0', '0');
...
(13, 'Comment Template', 'comment_automation/comment_template_manager', 1, 'fa fa-comment-dots', '251', 5, '0', '0', '0', '0', '0', 0),
(14, 'Reply Template', 'comment_automation/template_manager', 5, 'fa fa-reply-all', '80,220,222,223,256', 5, '0', '0', '0', '0', '0', 0),
(15, 'Automation Campaign', 'comment_automation/index', 9, 'fa fa-pen-alt', '80,204,206,251', 5, '0', '0', '0', '0', '0', 0),
(16, 'Report', 'comment_automation/comment_section_report', 17, 'fas fa-chart-pie', '80,201,202,204,206', 5, '0', '0', '0', '0', '0', 0),
...
INSERT INTO `menu_child_1` (`id`, `name`, `url`, `serial`, `icon`, `module_access`, `parent_id`, `have_child`, `only_admin`, `only_member`, `is_external`) VALUES (NULL, 'Automation Campaign', 'instagram_reply/get_account_lists', '1', 'fa fa-pen-alt', '278,279', 14, '0', '0', '0', '0');
INSERT INTO `menu_child_1` (`id`, `name`, `url`, `serial`, `icon`, `module_access`, `parent_id`, `have_child`, `only_admin`, `only_member`, `is_external`) VALUES (NULL, 'Report', 'instagram_reply/reports', '1', 'fas fa-chart-pie', '278,279', 14, '0', '0', '0', '0');
...
(1, 'Trial', '251,80,79,263,65,200,223,222,220,82,199,265,197,198,257,268,275,256,264,100,103,108,109,107,101,105,102,33,114,111,113,110,112,78,267,279', '{"251":"10","80":"10","79":"30","263":"10","65":"2","200":"10","223":"10","222":"10","220":"10","82":"0","199":"0","265":"5","197":"0","198":"0","257":"10","268":"0","275":"100","256":"5","264":"10","100":"0","103":"2","108":"2","109":"0","107":"2","101":"2","105":"2","102":"2","33":"2","114":"10","111":"10","113":"10","110":"10","112":"10","78":"0","267":"30","279":"10"}', '{"251":"0","80":"0","79":"50","263":"0","65":"0","200":"0","223":"0","222":"0","220":"0","82":"0","199":"0","265":"0","197":"0","198":"0","257":"0","268":"0","275":"0","256":"0","264":"0","100":"0","103":"0","108":"0","109":"0","107":"0","101":"0","105":"0","102":"0","33":"0","114":"5","111":"5","113":"5","110":"5","112":"5","78":"0","267":"0","279":"0"}', 'Trial', 7, '1,W', '1', '1', '0', '0');
...
CREATE TABLE IF NOT EXISTS `ecommerce_cart` (
  ...
  `payment_temp_session` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `medium_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `app_name` varchar(255) NOT NULL,
  `client_id` varchar(255) NOT NULL,
