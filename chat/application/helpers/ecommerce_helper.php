...
if ( ! function_exists('mec_sidebar'))
{
  function mec_sidebar($store_data=array(),$subscriber_id='',$current_cart=array())
  {
    ...
    $logout_menu  = '<li class="list-group-item d-flex justify-content-between align-items-center"><a href="" class="pointer" id="logout"><i class="fas fa-sign-out-alt"></i> '.$ci->lang->line("Logout").'</a></li>';
    ...
    <nav id="sidebar" class="nicescroll bg-white">
        ...
        <ul class="list-group list-group-flush m-0 mt-4 p-0">
            <li id="showProfile" class="list-group-item d-flex justify-content-between align-items-center"><a href="" class=""><i class="fas fa-user-circle"></i> '.$ci->lang->line("Profile").'</a></li>
            <li id="showAddress" data-close="0" class="list-group-item d-flex justify-content-between align-items-center"><a href="" class=""><i class="fas fa-truck"></i> '.$ci->lang->line("Delivery Address").'</a></li>
            <li class="list-group-item d-flex justify-content-between align-items-center"><a href="'.$my_orders_link.'" class=""><i class="fas fa-history"></i> '.$ci->lang->line("My Orders").'</a></li>
            '.$login_menu.'
            '.$logout_menu.'
        </ul>

        <div class="refund_terms"><span class="text-small text-dark">'.$terms.$refund.'</span></div>                 
    </nav>';
