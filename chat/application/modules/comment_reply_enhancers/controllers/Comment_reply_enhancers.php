...
class Comment_reply_enhancers extends Home
{
    ...
    public function activate()
    {
        ...
        $sql=array
        (
        	0 => "INSERT INTO `menu_child_1` (`name`, `url`, `serial`, `icon`, `module_access`, `parent_id`, `have_child`, `only_admin`, `only_member`, `is_external`) VALUES ('Tag Campaign', 'comment_reply_enhancers/post_list', '13', 'fas fa-tag', '201,202', '5', '0', '0', '0', '0');"
        ); 
    ...
    {        
        ...
        $sql = array
        (
          0 => "DELETE FROM `menu_child_1` WHERE `url` = 'comment_reply_enhancers/post_list'"
        ); 
