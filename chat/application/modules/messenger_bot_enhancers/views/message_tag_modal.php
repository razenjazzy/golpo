	        ...
	        <table class="table table-bordered table-striped">
	      	    ...
	      	    <tbody class="_5m37" id="u_0_1">
	      	        ...
	      	        <tr class="row_3 _5m29">
	      	            ...
	      	            <td>
	      	                <p>
	      	                	News messages allow news publishers to send regular news updates to their subscribers in Messenger. This feature is only available for registered news Pages under the <br><a href='https://www.facebook.com/help/publisher/316333835842972'> Facebook News Page Index (NPI)</a> <br> <a target='_BLANK' href='https://developers.facebook.com/docs/messenger-platform/policy/policy-overview/#news_messaging'>Read Policy Details here</a>
	      	                </p>
	      	            </td>
	      	            <td>
	      	                Registered news Pages under the <a target='_BLANK' href='https://www.facebook.com/help/publisher/316333835842972'> Facebook News Page Index (NPI)</a>
	      	            </td>
	      	            <td>
	      	               <a target='_BLANK' href='https://developers.facebook.com/docs/messenger-platform/policy/policy-overview/#news_messaging'>Read Policy Details here</a>
	      	            </td>
	      	        </tr>
	      	    </tbody>
	      	</table>
