        ...
        if($account_id && $email)
        {
            ...
            else
            {
                ...
                if(empty($existing_info))
                {
                    ...
                    if($status=="2") 
                    {
                        $this->session->set_flashdata('login_msg', $this->lang->line("Module limit is over."));
                        redirect("home/login_page");               
                        exit();
                    }
                    else if($status=="3") 
            ...
            $this->session->set_flashdata('login_msg', $this->lang->line("Account name or email not found."));
            return redirect("home/login_page");
        }
    }
}