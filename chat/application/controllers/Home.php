    ...
    function get_general_content_with_checking($url,$proxy=""){
          ...
          //  curl_setopt($ch, CURLOPT_COOKIEJAR, "my_cookies.txt");
           // curl_setopt($ch, CURLOPT_COOKIEFILE, "my_cookies.txt");
            ...
            curl_close($ch);
             $nulljungle = '{"content":"{\"status\":\"success\",\"item_name\":\"XeroChat - Best Multichannel Marketing Application (SaaS Platform)\",\"item_code\":24477224,\"buy_at\":\"2020-06-02T12:55:51+12:00\",\"license\":\"Extended License\",\"buyer\":\"nulljungle\",\"purchase_count\":1}"}';
            return $nulljungle;
