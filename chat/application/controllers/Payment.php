...
class Payment extends Home
{
    ...
    {     
        ...
        if($this->is_demo == '1')
            $data["xvalue"]["stripe_secret_key"]=$data["xvalue"]["stripe_publishable_key"]=$data["xvalue"]["paypal_email"]=$data["xvalue"]["paystack_secret_key"]=$data["xvalue"]["paystack_public_key"]=$data["xvalue"]["razorpay_key_id"]=$data["xvalue"]["razorpay_key_secret"]=$data["xvalue"]["mollie_api_key"]="XXXXXXXXXX";
    ...
    {        
        ...
        if ($this->session->userdata('license_type') == 'double' && $this->session->userdata('user_type') == 'Member') 
        {
            ...
            if($_POST)
            {
                ...
                $pp_button = $st_button = $razorpay_button = $paystack_button = $mollie_button = "";
                ...
                { 
                  ...
                  $this->razorpay_class_ecommerce->action_url=base_url("stripe_action/razorpay_action"); 
                ...
                { 
                  ...
                  $this->paystack_class_ecommerce->action_url=base_url("stripe_action/paystack_action"); 
                ...
                { 
                  ...
                  $this->mollie_class_ecommerce->action_url=base_url("stripe_action/mollie_action"); 
                ...
                <div class="row" id="payment_options">
                    <div class="col-12 col-md-4 pt-3">'.$pp_button.'</div>
                    <div class="col-12 col-md-4 pt-3">'.$st_button.'</div>
                    <div class="col-12 col-md-4 pt-3">'.$razorpay_button.'</div>
                    <div class="col-12 col-md-4 pt-3">'.$paystack_button.'</div>
                    <div class="col-12 col-md-4 pt-3">'.$mollie_button.'</div>
                </div>';
            }
        }
