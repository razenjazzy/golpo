...
class Twitter{
  ...
  public function login_button($redirect_rul)
  {
    ...
    if(!isset($reply->oauth_token) || !isset($reply->oauth_token_secret)) {
      ...
      return "<a href='{$auth_url}' class='btn btn-outline-primary login_button' social_account='twitter' error='". $error_message ."'><i class='fas fa-plus-circle'></i> ".$this->CI->lang->line('Import Account')."</a>";
    }
