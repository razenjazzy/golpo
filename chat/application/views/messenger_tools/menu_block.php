  ...
  <div class="section-body">
          ...
          <div class="card-body">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" style="width:220px;">
                <div class="dropdown-title"><?php echo $this->lang->line("Tools"); ?></div>                        
                <a class="dropdown-item has-icon" href="<?php echo base_url('custom_field_manager/campaign_list'); ?>"><i class="fas fa-check-square"></i> <?php echo $this->lang->line("User Input Flow Campaign"); ?></a>
                <a class="dropdown-item has-icon" href="<?php echo base_url('custom_field_manager/custom_field_list'); ?>"><i class="fas fa-check-square"></i> <?php echo $this->lang->line("Custom Fields"); ?></a>
              </div>
            </div>
    ...
    <?php endif; ?> 
      ...
      <?php endif; ?>
       ...
       <?php 
      if($this->basic->is_exist("modules",array("id"=>293))) :
      if($this->session->userdata('user_type') == 'Admin' || in_array(293,$this->module_access)) : ?>
      <div class="col-lg-6">
        <div class="card card-large-icons">
          <div class="card-icon text-primary">
          ...
          <div class="card-body">
            <h4><?php echo $this->lang->line("WooCommerce Integration"); ?></h4>
            <p><?php echo $this->lang->line("Import products, load as webview, export to Ecommerce..."); ?></p>
            
            <div class="dropdown">
              <a href="<?php echo base_url('woocommerce_integration'); ?>"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
            </div>
