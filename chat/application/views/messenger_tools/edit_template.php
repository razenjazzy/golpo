...
<script type="text/javascript">
  ...
  <?php for($template_type=1;$template_type<=6;$template_type++){ ?>
   ...
   <?php } ?>
      ...
      $("document").ready(function(){
        ...
        var template_type_array = ['text','image','audio','video','file','quick_reply','text_with_buttons','generic_template','carousel','list','media','One_Time_Notification','User_Input_Flow'];
      ...
      $(document).on('change',"#template_type_<?php echo $template_type ?>",function(){
        ...
        var template_type_array = ['text','image','audio','video','file','quick_reply','text_with_buttons','generic_template','carousel','media','One_Time_Notification','User_Input_Flow'];
        template_type_array.forEach(templates_hide_show_function);
        function templates_hide_show_function(item, index)
        {
          var template_type_preview_div_name = "#"+item+"_preview_div";
  ...
  $(document).ready(function() {
    ...
    $('#add_template_modal').on('shown.bs.modal',function(){ 
      ...
      var iframe_link="<?php echo base_url('messenger_bot/create_new_template/1/');?>"+page_id+"?lev="+rand_time;
