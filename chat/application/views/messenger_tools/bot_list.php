        ...
        <div class="card-header padding-left-10 padding-right-10">
          ...
          <div class="col-4 padding-0">
            ...
            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width: 250px;">
              ...
              <li><a class="dropdown-item has-icon tree_bot" href="#"><i class="fas fa-sitemap"></i> <?php echo $this->lang->line("Messenger bot tree view");?></a></li>
              <li><a class="dropdown-item has-icon export_bot" table_id="" href="#"><i class="fas fa-file-export"></i> <?php echo $this->lang->line("Export bot settings");?></a></li>
              <li><a class="dropdown-item has-icon import_bot" table_id="" href="#"><i class="fas fa-file-import"></i> <?php echo $this->lang->line("Import bot settings");?></a></li>
              <?php endif; ?>
           </ul>
          </div>
        </div>
