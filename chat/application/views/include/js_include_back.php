...
<script type="text/javascript">
  $(document).ready(function() { 
    ...
    var is_mobile =  '<?php echo $this->session->userdata("is_mobile");?>';
      ...
      if(is_mobile=='0' && ( (controller_name=="ecommerce" && (function_name=="store_list" || function_name=="")) || (controller_name=="appointment_booking" && (function_name=="dashboard" || function_name=="")) || (controller_name=="comment_automation" && (function_name=="index" || function_name=="")) ||(controller_name=="messenger_bot" && (function_name=="bot_list")) || (controller_name=="subscriber_manager" && (function_name=="sync_subscribers")) ||(function_name=="tree_view")))
