...
<!-- 			<div class="col-lg-6">
				<div class="card card-large-icons">
					...
					<div class="card-body">
						<h4><?php echo $this->lang->line("Business Discovery"); ?></h4>
						<p><?php echo $this->lang->line("Get busineess account info"); ?></p>
						<a href="<?php echo base_url("instagram_reply/business_discovery"); ?>" class="card-cta"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
					</div>
				</div>
			</div> -->
