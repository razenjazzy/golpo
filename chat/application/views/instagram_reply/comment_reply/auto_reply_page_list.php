<?php 
	...
	include("application/views/instagram_reply/comment_reply/comment_reply_css.php");
                ...
                <div class="modal-body" id="auto_reply_message_modal_body">
                    ...
                    <div class="row"
                        ...
                        <div class="col-12 col-md-12" id="delete_offensive_comment_keyword_div">
                            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <textarea class="form-control message" name="delete_offensive_comment_keyword" id="delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions") ?>" style="height:70px !important;"></textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group" style="background: #F5F5F5; border: 1px solid #ccc; padding: 10px;">
                                <label><?php echo $this->lang->line("private reply message after deleting offensive comment") ?>
                                    ...
                                    <a href="#" data-placement="bottom" data-toggle="popover" data-trigger="focus"
                                       title="<?php echo $this->lang->line("message") ?>" data-content="<?php echo $this->lang->line("type your comment reply here...Keep it blank for no actions"); ?>"><i
                                                class='fa fa-info-circle'></i> </a>
                                </label><br/>

                                <textarea class="form-control message" name="private_message_offensive_words" id="private_message_offensive_words" placeholder="<?php echo $this->lang->line("type your comment reply here...Keep it blank for no actions") ?>" style="height:100px;"></textarea>                                
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12" id="generic_message_div" style="display: none;">
                            ...
                            <textarea class="form-control message" name="generic_message" id="generic_message" placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>" style="height:170px !important;"></textarea>
                        ...
                        <div class="col-12" id="filter_message_div" style="display: none;">
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group" id="filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
                                   ...
                                   <span class="red">*</span>
                                    ...
                                    <div class="clearfix"></div>
                                    <textarea class="form-control message" name="comment_reply_msg_<?php echo $i; ?>" id="comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>" style="height:170px !important;"></textarea>
                                </div>
                            <?php endfor; ?>
                            ...
                            <div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #ccc; padding: 10px;">
                            	...
                            	<div class="clearfix"></div>
                            	<textarea class="form-control message" name="nofilter_word_found_text" id="nofilter_word_found_text" placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>" style="height:170px !important;"></textarea>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" id="edit_auto_reply_info_form" method="post">
                ...
                <div class="modal-body" id="edit_auto_reply_message_modal_body">
                    ...
                    <div class="text-center waiting previewLoader"><i class="fas fa-spinner fa-spin blue text-center" style="font-size: 40px;"></i></div><br>
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px; <?php if (!$commnet_hide_delete_addon) echo "display: none;"; ?> ">
                        ...
                        <div class="col-12 col-md-12" id="edit_delete_offensive_comment_keyword_div">
                            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <textarea class="form-control message" name="edit_delete_offensive_comment_keyword" id="edit_delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions") ?>" style="height:70px !important;"></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- end of comment hide and delete section -->
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12" id="edit_generic_message_div" style="display: none;">
                            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control message" name="edit_generic_message" id="edit_generic_message" placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>" style="height:170px !important;"></textarea>
                            </div>
                        </div>
                        <div class="col-12" id="edit_filter_message_div" style="display: none;">
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group" id="edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 10px; margin-bottom: 50px;">
                                    <label>
                                    ...
                                    <div class="clearfix"></div>
                                    <textarea class="form-control message" name="edit_comment_reply_msg_<?php echo $i; ?>" id="edit_comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>" style="height:170px !important;"></textarea>
                                </div>
                            <?php endfor; ?>
                            ...
                            <div class="form-group" id="edit_nofilter_word_found_div"
                                 style="margin-top: 10px; border: 1px solid #e4e6fc; padding: 10px;">
                                <label>
                                ...
                                <textarea class="form-control message" name="edit_nofilter_word_found_text"
                                          ...
                                          placeholder="<?php echo $this->lang->line("type your comment reply here...") ?>"
...
<div class="modal fade" id="media_insights_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="min-width: 50%;max-width: 50%">
...
<div class="modal fade" id="all_comments_modal">
    <div class="modal-dialog" style="min-width: 50%;max-width: 50%">
        <div class="modal-content">
            <!-- <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-list"></i> <?php echo $this->lang->line("All comment list") ?></h5>
