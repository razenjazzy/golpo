	...
	$(document).ready(function($) {
		      ...
		      if (response.reply_type == 'generic') {
		       ...
		       if(emoji_load_div_list == '')
		        ...
		        for (var i = 0; i < auto_reply_text_array.length; i++) {
		          ...
		          var unscape_reply_text = auto_reply_text_array[i]['reply_text'];
		          $("#full_edit_filter_message_" + j).html(unscape_reply_text);
		          var unscape_comment_reply_text = auto_reply_text_array[i]['comment_reply_text'];
		...
		$(document).on('click','.view_report',function(e){
		  e.preventDefault();
		    ...
		    $("#contents").html('<div class="text-center waiting"><i class="fas fa-spinner fa-spin blue text-center" style="font-size: 40px;"></i></div');
		...
		$(document).on('click','.check_all_comments',function(e){
		  e.preventDefault();
		    ...
		    $("#all_comments_modal_contents").html('<div class="text-center waiting p-4"><i class="fas fa-spinner fa-spin blue text-center" style="font-size: 60px;"></i></div');
