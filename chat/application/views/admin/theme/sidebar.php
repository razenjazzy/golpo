...
(
  ...
  base_url("messenger_bot_connectivity/json_api_connector") => base_url("messenger_bot"),
  ...
  base_url("woocommerce_abandoned_cart") => base_url("messenger_bot"),
  base_url("woocommerce_abandoned_cart/recovery_plugin_add") => base_url("messenger_bot"),
  base_url("woocommerce_abandoned_cart/recovery_plugin_edit") => base_url("messenger_bot"),
  base_url("woocommerce_abandoned_cart/recovery_plugin_report") => base_url("messenger_bot"),
  base_url("email_auto_responder_integration/mailchimp_list") => base_url("messenger_bot"),
  ...
  base_url("sms_email_manager/sms_api_lists") => base_url("messenger_bot_broadcast"),
  ...
  base_url("sms_email_manager/smtp_config") => base_url("messenger_bot_broadcast"),
  base_url("sms_email_manager/mandrill_api_config") => base_url("messenger_bot_broadcast"),
  base_url("sms_email_manager/sendgrid_api_config") => base_url("messenger_bot_broadcast"),
  base_url("sms_email_manager/mailgun_api_config") => base_url("messenger_bot_broadcast"),
  ...
  base_url("comboposter/social_accounts") => base_url("ultrapost"),
