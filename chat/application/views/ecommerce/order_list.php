          ...
          <div class="card-body data-card p-0 pr-3">
            <div class="row">
              ...
              <div class="col-12 text-left">
                <?php
                  echo '<a href="'.base_url("ecommerce/download_csv").'" target="_BLANK" class="btn btn-primary float-right"><i class="fas fa-file-csv"></i> '.$this->lang->line("Download Orders").'</a>';
                ?>                                         
              </div>
            </div>
