...
<html lang="en">
    ...
    if(isset($social_analytics_codes)) 
    {
        ...
        else echo mec_sticky_footer($social_analytics_codes,$subscriberId,$currentCart);
    }
    ?>
	</body>
</html>
...
<div class="modal fade" id="TermsModal" tabindex="-1" role="dialog" aria-labelledby="TermsModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="TermsModalLabel"><i class="fas fa-book-open"></i> <?php echo $this->lang->line("Terms of Use"); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
...
<div class="modal fade" id="RefundModal" tabindex="-1" role="dialog" aria-labelledby="RefundModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="RefundModalLabel"><i class="fas fa-hand-holding-usd"></i> <?php echo $this->lang->line("Refund Policy"); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-justify" id="LoginModalBody">
            ...
            <div class="text-center mt-4 mb-3">
              <div class="text-job text-muted"><a href="" class="pointer" id="register_form"><?php echo $this->lang->line("Do not have an account? Register here.");?></a></div>
            </div>  
      </div>
    </div>
  </div>
