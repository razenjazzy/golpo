...
$apply_coupon = '
<a class="collpase_link float-left" data-toggle="collapse" href="#collapsecoupon" role="button" aria-expanded="false" aria-controls="collapsecoupon"><i class="fas fa-gift ml-0"></i> '.$this->lang->line("Apply Coupon").'</a>
<a class="float-right" id="showProfile" href="#"><i class="fas fa-map-marker-alt"></i> '.$this->lang->line("Billing Address").'</a> 
...
<a class="collpase_link" data-toggle="collapse" href="#collapsenote" role="button" aria-expanded="false" aria-controls="collapsenote"><i class="fas fa-sticky-note ml-0"></i> '.$this->lang->line("Write a note").'</a><div class="input-group collapse pt-2" id="collapsenote">
...
<div class="invoice p-0 pt-2 no_shadow bg-light">
  ...
  <div class="invoice-print"> 
    ...
    <div class="row">      
      ...
      <ul class="list-group w-100 bordered">
        <li class="list-group-item d-flex justify-content-between align-items-center no_border text-muted pl-3 pr-3 pt-1 pb-1">
    ...
    <div class="row">
      <div class="col-12 p-0">
        <!-- <div style="height: <?php echo $height; ?>;"></div> -->
        <ul class="list-unstyled list-unstyled-border bg-white w-100 pt-3 pr-3 pb-2 pl-3 bordered border-top-0 border-top-0" id="delivery_address_select">
          <li class="media">
            ...
            <div class="media-body">
              <div class="btn btn-sm btn-outline-primary mb-1 float-right pointer <?php echo $hide_delivery_address; ?>" data-close='1' id="showAddress"><i class="fas fa-edit"></i> <?php echo $this->lang->line("Manage Address"); ?></div>
              <h6 class="media-title"><a href="#" class="text-primary"><i class="fas fa-truck"></i> <?php echo $this->lang->line("Deliver to"); ?></a></h6>
              ...
              <div class="form-group mb-0 <?php echo $hide_store_pickup; ?>">
                <label class="custom-switch mt-2">
                  ...
                  <span class="custom-switch-description mb-0 text-primary"><?php echo $this->lang->line($store_pickup_title); ?></span>
                </label>
                <select class="form-control <?php if($check_store_pickup=='') echo 'd-none'; ?>" name="pickup_point_details" id="pickup_point_details">
                  ...
                  foreach ($pickup_point_list as $key => $value)
                  {
                    ...
                    $select_it = $webhook_data_final['pickup_point_details'] == $tmp ? 'selected' : '';
...
<style type="text/css">
  ...
  @media (max-width: 978px) {
    #proceed_checkout{font-weight: bold;font-size: 14px;position: fixed;border-radius: 0;z-index: 99;bottom:65px;left:0;}
  }
 }
</style>
