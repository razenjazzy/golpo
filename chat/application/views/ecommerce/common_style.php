<style type="text/css">
  ...
  .section .section-title:before{margin:0 5px 0 0 !important;width:15px!important;float:none!important;}
  ...
  #sticky-footer .breadcrumb-item i{font-size: 20px;margin:0;margin-bottom: 7px;}
  #sticky-footer a{text-decoration: none;}
  .search_form #search{height: 35px;border-radius: 20px;}
  .search_form #submit{height: 35px;border-radius: 0 20px 20px 0!important;}
