      ...
      <div class="row multi_layout">
              ...
              <ul class="list-group" id="page_list_ul" style="margin-top: 20px;">
                ...
                { 
                  ...
                  <li class="list-group-item <?php if($value['id']==$this->session->userdata("ecommerce_selected_store")) echo 'active'; ?> page_list_item" page_table_id="<?php echo $value['id']; ?>">
                    <h6 class="page_name"><i class="fas fa-store"></i> <?php echo str_replace(array('https://','http://'), '', $value['store_name']); ?></h6>
                  </li>
                  <?php $i++; 
                } ?>                
              </ul>
        ...
        <div class="col-12 col-md-9 col-lg-8 colrig" id="right_column">
          ...
          <div class="card main_card">
            <div class="card-header">
              <div class="col-8 p-0">
                <h4 id="right_column_title"><i class="fas fa-tachometer-alt"></i> <a title="<?php echo $this->lang->line("Visit Store"); ?>" data-toggle="tooltip" target="_BLANK" href="<?php echo base_url('ecommerce/store/'.$current_store_data['store_unique_id']); ?>"><?php echo str_replace(array('https://','http://'), '', $current_store_data['store_name']); ?></a> (<a title="<?php echo $this->lang->line("Visit Page"); ?>" data-toggle="tooltip" target="_BLANK" href="https://facebook.com/<?php echo  $current_store_data['fb_page_id']; ?>"><?php echo $current_store_data['page_name']; ?></a>) <span id='iframe_title'> : <?php echo $this->lang->line("Dashboard"); ?></span></h4>
              </div>
                                ...
                                { 
                                  ...
                                  <li class="media webhook_data pointer" data-id="'.$value['id'].'" data-toggle="tooltip" title="'.$value['email']." (".$value['subscriber_id'].')">
                                      ...
                                      <div class="media-body">
                                        <div class="float-right text-primary text-small">'.$hook_ago.'</div>
                                        <div class="media-title"><i class="'.$hook_class.'"></i> '.$hook_user.'</div>
