<script type="text/javascript">
	...
	function load_data(start,reset,popmessage,comment_id) 
	{
	  ...
	  $.ajax({
	    ...
	    type: 'POST',
	    dataType : 'JSON',
	    data: {start:start,limit:limit,product_id:current_product_id,store_id:current_store_id,store_favicon:store_favicon,store_name:store_name,comment_id:comment_id,subscriber_id:subscriber_id},
	...
	$(document).ready(function() {
		$(document).on('click','.leave_comment',function(e){
		  ...
		  $.ajax({
		    ...
		    data:{product_id:current_product_id,store_id:current_store_id,new_comment:new_comment,subscriber_id:subscriber_id,parent_product_comment_id:parent_product_comment_id,product_name:product_name},
		    success:function(response){
