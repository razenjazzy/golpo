          ...
          <div class="card-body data-card p-0 pt-1 pr-3">
            <div class="row">              
              ...
              <div class="col-5 col-sm-12">  
                 <a href="<?php echo base_url('ecommerce/add_coupon'); ?>" class="btn btn-lg float-right btn-primary"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line("Add Coupon"); ?></a>
                <?php
                ?>                                         
              </div>
            </div>
