...
<div class="container-m--x container-m--y mb-4" style="background: url('<?php echo base_url().'uploads/profile/background/'.$user[0]->profile_background;?>') 50%;">
  <div class="media col-md-10 col-lg-8 col-xl-7 py-5 mx-auto"> <img src="<?php echo $de_file;?>" alt="" class="d-block ui-w-100 rounded-circle">
    <div class="media-body ml-5">
      <h4 class="font-weight-bold mb-4" style="color:#ffffff;"><?php echo $first_name. ' ' .$last_name;?></h4>
      <div class="text-muted mb-4">
        <?php if($system[0]->enable_profile_background=='yes'):?>
        <?php $attributes = array('name' => 'profile_background', 'id' => 'profile_background', 'autocomplete' => 'off');?>
        <?php $hidden = array('u_profile_picture' => 'UPDATE');?>
        <?php echo form_open_multipart('admin/settings/profile_background/', $attributes, $hidden);?>
        <?php
		  $data_usr = array(
				'type'  => 'hidden',
				'name'  => 'user_id',
        ...
        <div class="col-md-2">
          <div class="btn-group hidden-md-down" role="group" aria-label="Basic example"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_save'))); ?> </div>
        </div>
        <?php echo form_close(); ?>
        <?php endif; ?>
      </div>
      <strong style="color:#ffffff;"><?php echo $this->lang->line('dashboard_last_login');?></strong> <span class="text-mutded" style="color:#ffffff;">
      <?php 
      ...
      <?php echo $this->lang->line('xin_e_details_from');?> <?php echo $last_login_ip;?></span> </div>
  </div>
  <hr class="m-0">
</div>
...
<div class="row match-heights">
    ...
    <div class="card">
      <div class="card-blocks">
        <div class="list-group">
          ...
          <a class="list-group-item list-group-item-action nav-tabs-link" href="#work_experience" data-profile="8" data-profile-block="work_experience" data-toggle="tab" aria-expanded="true" id="user_profile_8"> <i class="fas fa-hourglass-half"></i> <?php echo $this->lang->line('xin_e_details_w_experience');?> </a>
          <?php } ?>
          ...
          <?php } ?>
          <a class="list-group-item list-group-item-action nav-tabs-link" href="#shift" data-profile="12" data-profile-block="shift" data-toggle="tab" aria-expanded="true" id="user_profile_12"> <i class="fas fa-user-clock"></i> <?php echo $this->lang->line('xin_e_details_shift');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link" href="#change_password" data-profile="14" data-profile-block="change_password" data-toggle="tab" aria-expanded="true" id="user_profile_14"> <i class="fa fa-key"></i> <?php echo $this->lang->line('xin_e_details_cpassword');?> </a> </div>
      </div>
    </div>
  </div>
  <div class="col-md-9 current-tab animated fadeInRight" id="user_basic_info"  aria-expanded="false">
    ...
    <?php
        ...
        ?>
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_e_details_basic_info');?> </h6>
      <div class="card-body">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="profile_picture" style="display:none;">
    ...
    <?php
        ...
        ?>
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_e_details_profile_picture');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="row">
            <div class="col-md-12">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="social_networking" style="display:none;">
    ...
    <?php
		...
		?>
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_e_details_social');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="row">
            <div class="col-md-6">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="immigration" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_employee_immigration');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_assigned_immigration');?> <?php echo $this->lang->line('xin_records');?> </h6>
      <div class="card-body">
        <div class="card-block">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="contact" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_contact');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_contacts');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="document" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_document');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_documents');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="qualification" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_qualification');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_qualification');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="work_experience" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_w_experience');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_w_experience');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="bank_account" style="display:none;">
    <div class="card md-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_baccount');?> </h6>
      <div class="card-body">
        <div class="card-block">
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_baccount');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
...
?>
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_e_details_shift');?> </h6>
      <div class="card-body">
        <div class="card-block">
          <div class="table-responsive" data-pattern="priority-columns">
