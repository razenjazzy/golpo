...
<div class="row m-b-1 animated fadeInRight">
  <div class="col-md-3">
    <div class="card">
      ...
      <h6 class="card-header"> <?php echo $this->lang->line('xin_departments');?> </h6>
  ...
  <div class="col-md-9">
    <div class="card mb-4">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_files');?> </h6>
      <div class="card-body">
        <?php //if($user[0]->user_role_id==1){?>
    ...
    <div class="card">
      <h6 class="card-header"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_files');?> </h6>
