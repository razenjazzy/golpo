...
<?php $attributes = array('name' => 'edit_expense', 'id' => 'edit_expense', 'autocomplete' => 'off');?>
<?php $hidden = array('_method' => 'EDIT','_token' => $expense_id);?>
<?php echo form_open_multipart('admin/user/update_expense/'.$expense_id, $attributes, $hidden);?>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class='form-group'>
          ...
          <a href="<?php echo site_url("employee/download?type=expense&filename=".$billcopy_file."") ?>"><?php echo $this->lang->line('xin_download_file');?></a>
          <?php } ?>
        </div>
      </div>
        </div>
