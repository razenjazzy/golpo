...
<?php $attributes = array('name' => 'edit_bug', 'id' => 'edit_bug', 'autocomplete' => 'off');?>
<?php $hidden = array('method' => 'EDIT');?>
<?php echo form_open('admin/user/change_bug_status/'.$bug_id, $attributes, $hidden);?>
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var xin_bug_table = $('#xin_bug_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : site_url+"user/project_bug_list/<?php echo $project_id; ?>",
								type : 'GET'
							},
							"iDisplayLength": 25,
