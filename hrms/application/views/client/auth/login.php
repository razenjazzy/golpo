...
<div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url();?>skin/hrsale_assets/img/bg/bg-3.jpg');">
    ...
    <div class="card">
        ...
        <?php //$ilogn_info = 'client1@golpocom.com';?>
        <?php //$ilogn_info2 = 'client2@golpocom.com';?>
        ...
        <div class="d-flex justify-content-between align-items-center m-0">
            ...
            <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary save', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> '.$this->lang->line('xin_login'))); ?> </div>
        <?php echo form_close(); ?>
          </div>
