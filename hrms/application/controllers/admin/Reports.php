...
class Reports extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function payslip() {
		...
		$data['title'] = $this->lang->line('xin_hr_reports_payslip');
	...
	public function projects() {
		...
		$data['title'] = $this->lang->line('xin_hr_reports_projects');
	...
	public function tasks() {
		...
		$data['title'] = $this->lang->line('xin_hr_reports_tasks');
	...
	public function roles() {
		...
		$data['title'] = $this->lang->line('xin_hr_report_user_roles_report');
	...
	public function employees() {
		...
		$data['title'] = $this->lang->line('xin_hr_report_employees');
	...
	public function employee_attendance() {
		...
		$data['title'] = $this->lang->line('xin_hr_reports_attendance_employee');
	...
	public function employee_training() {
		...
		$data['title'] = $this->lang->line('xin_hr_reports_training');
