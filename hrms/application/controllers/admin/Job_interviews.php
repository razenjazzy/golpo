    ...
    public function interview_list()
     {
		...
		$data[] = array(
			'<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_delete').'"><button type="button" class="btn icon-btn btn-xs btn-outline-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->job_interview_id . '"><span class="far fa-trash-alt"></span></button></span>',
			$job_title,
			$interviewees,
			$r->interview_place,
			$interview_d_t,
