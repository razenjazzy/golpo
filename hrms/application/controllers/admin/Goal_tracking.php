...
class Goal_tracking extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['title'] = $this->lang->line('xin_hr_goal_tracking');
	 ...
	 public function type()
     {
		...
		$data['title'] = $this->lang->line('xin_hr_goal_tracking_type');
    ...
    public function type_list()
     {
		...
		$data[] = array(
			'<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_edit').'"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light"  data-toggle="modal" data-target=".edit-modal-data"  data-tracking_type_id="'. $r->tracking_type_id . '"><span class="fas fa-pencil-alt"></span></button></span><span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_delete').'"><button type="button" class="btn icon-btn btn-xs btn-outline-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->tracking_type_id . '"><span class="far fa-trash-alt"></span></button></span>',
			$comp_name,
			$r->type_name
		);
      }
	 ...
	 public function goal_tracking_list()
     {
        ...
        foreach($tracking->result() as $r) {
			...
			// progress
			$pbar = '<p class="m-b-0-5">'.$this->lang->line('xin_completed').'</p><div class="progress"><div class="progress-bar '.$progress_class.' progress-sm" style="width: '.$r->goal_progress.'%;">'.$r->goal_progress.'%</div></div>';
		...
		$data[] = array(
			'<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_edit').'"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light"  data-toggle="modal" data-target=".edit-modal-data"  data-tracking_id="'. $r->tracking_id . '"><span class="fas fa-pencil-alt"></span></button></span><span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view').'"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-tracking_id="'. $r->tracking_id . '"><span class="fa fa-eye"></span></button></span><span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_delete').'"><button type="button" class="btn icon-btn btn-xs btn-outline-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->tracking_id . '"><span class="far fa-trash-alt"></span></button></span>',
			$comp_name,
			$itype,
			$r->subject,
			$r->target_achiement,
