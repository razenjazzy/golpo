...
<div class="authentication-wrapper authentication-1 px-4">
    ...
    <div class="form-group">
        ...
        <div><?php echo $this->lang->line('xin_pincode');?></div>
        ...
        <input type="password" class="form-control" id="ipincode" name="ipincode" placeholder="<?php echo $this->lang->line('xin_enter_pincode');?>">
      </div>
    <div class="d-flex justify-content-between align-items-center m-0">
        <label class="custom-control custom-checkbox m-0"> &nbsp; </label>
        <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> '.$this->lang->line('xin_login'))); ?> </div>
    <?php echo form_close(); ?> 
    <!-- / Form -->
