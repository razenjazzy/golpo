...
<div class="form-group">
   ...
   <select name="employee_id" id="up_employee_id" class="form-control custom-select" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee');?>" required>
    <option value=""></option>
