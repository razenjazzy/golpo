  ...
  <div class="col-md-4 <?php echo $get_animate;?>">
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_task_detail');?></strong></span> </div>
            <div class="box-body">
    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card">
        <ul class="nav nav-tabs nav-topline">
          ...
          <li class="nav-item"> <a class="nav-link" id="baseIcon-tab13" data-toggle="tab" aria-controls="tabIcon13" href="#files" aria-expanded="false"><i class="fas fa-file-signature"></i> <?php echo $this->lang->line('xin_task_files');?></a> </li>
        ...
        <div class="tab-content pt-1">
          ...
          <div class="tab-pane <?php echo $get_animate;?>" id="comments" aria-labelledby="baseIcon-tab12" aria-expanded="false">
            <div class="card-body">
              ...
              <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_all_comments');?></strong></span> </div>
              <div class="card-body">
