                  ...
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
					 ...
					 // $allowance_amount += $eallowance_amount;
                      ?>
                      <tr>
                        <td><strong><?php echo $sl_allowances->allowance_title;?> (<?php echo $allowance_amount_opt;?>) (<?php echo $allowance_opt;?>):</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($allowance_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
