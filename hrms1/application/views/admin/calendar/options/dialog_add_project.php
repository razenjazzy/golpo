...
<?php echo form_open('admin/project/add_project', $attributes, $hidden);?>
  ...
  <h4 class="text-center text-big mb-4"><strong><?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_project');?></strong></h4>
    <div class="bg-white">
      <div class="box-block">
        <div class="row">
          <div class="col-md-6">
...
$(document).ready(function() {
	...
	jQuery("#aj_company").change(function(){
		jQuery.get(site_url+"project/get_employees/?cid="+jQuery(this).val(), function(data, status){
