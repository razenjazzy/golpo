...
<div class="card-header with-elements"> <span class="card-header-title mr-2">&nbsp;</span>
      ...
      <a href="<?php echo site_url('client/invoices/preview/'.$invoice_id);?>" class="btn btn-sm btn-outline-primary waves-effect waves-light" target="_blank"><span class="fa fa-credit-card"></span> <?php echo $this->lang->line('xin_acc_pay_now');?></a>
      <?php } ?> 
      </div>
    </div>
