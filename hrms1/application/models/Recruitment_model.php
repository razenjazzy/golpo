...
class Recruitment_model extends CI_Model {
	...
	public function get_all_jobs_desc() {
		...
		$query = $this->db->query("SELECT * FROM xin_jobs where status='1' order by job_id desc");
		return $query->result();
	}
	...
	public function get_all_jobs_last_desc() {
		...
		$query = $this->db->query("SELECT * FROM xin_jobs where status='1' order by job_id desc limit 5");
		return $query->result();
	}
	...
	public function get_featured_jobs_last_desc() {
		...
		$query = $this->db->query("SELECT * FROM xin_jobs where is_featured = '1' and status='1' order by job_id desc limit 5");
		return $query->result();
	}
   ...
   public function search_fetch_all_jobs($limit, $start, $search) {
	...
	public function get_employers() {
		$query = $this->db->query("SELECT * FROM xin_users");
		return $query;
	}
}