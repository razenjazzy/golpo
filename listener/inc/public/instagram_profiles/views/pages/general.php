<div class="widget-box-add-account">
	...
	<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
		<?php if( get_option('instagram_login_user', 0)){?>
	  	...
	  	<li class="nav-item">
	    	<a class="nav-link" id="instagram-app-tab" data-toggle="tab" href="#instagram-app" role="tab" aria-controls="instagram-app" aria-selected="false"><i class="<?php _e($module_icon)?>"></i> <?php _e("Button")?></a>
	  	</li>
	  	<?php }?>
	</ul>
	<div class="tab-content p-t-25" id="myTabContent">
		<?php if( get_option('instagram_login_user', 0)){?>
	  	...
	  	<?php }?>
	  	<?php if( get_option('instagram_login_button', 0)){?>
	  	<div class="tab-pane fade" id="instagram-app" role="tabpanel" aria-labelledby="instagram-app-tab">
