<div class="widget-box-add-account">
	...
	<div class="note">
		...
		<a href="<?php _e( get_module_url('oauth') )?>" class="btn btn-social"><i class="<?php _e( $module_icon )?>" style="color: <?php _e($module_color)?>"></i> <?php _e('Re-connect with Linkedin')?></a>
	</div>
</div>