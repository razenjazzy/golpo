<?php
class youtube_profiles_model extends MY_Model {
	...
	public function block_accounts($path = ""){
		...
		$team_id = _t('id');
		$result = $this->main_model->fetch('*', $this->tb_account_manager, "social_network = 'youtube' AND category = 'profile' AND team_id = '".$team_id."'");
		return [
			'position' => 700,
			'id' => $this->module_id,
