			...
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<select class="form-control action-save" name="op_directs[by]">
  					<option <?php pinav($a, "op_directs", "by", "follower") ?> value="follower"><?php _e("New followers")?></option>
					<option <?php pinav($a, "op_directs", "by", "target") ?> value="target"><?php _e("Targets")?></option>
  				</select>
				</div>
			</div>
		</div>
