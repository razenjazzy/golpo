	...
	<div class="row">
			...
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<select class="form-control speed-level" name="speeds[level]">
	  					<option <?php pinav($a, "speeds", "level", "slow") ?> value="slow" data-speed="[<?php _e( implode(",", $slow_speed) )?>]"><?php _e("Slow")?></option>
						<option <?php pinav($a, "speeds", "level", "normal") ?> value="normal" data-speed="[<?php _e( implode(",", $normal_speed) )?>]"><?php _e("Normal")?></option>
						<option <?php pinav($a, "speeds", "level", "fast") ?> value="fast" data-speed="[<?php _e( implode(",", $fast_speed) )?>]"><?php _e("Fast")?></option>
						<option <?php pinav($a, "speeds", "level", "") ?> value="" disabled="" class=""><?php _e("Custom")?></option>
	  				</select>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="speeds[comment]" value="<?php pinav($a, "speeds", "comment")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="speeds[follow]" value="<?php pinav($a, "speeds", "follow")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="speeds[unfollow]" value="<?php pinav($a, "speeds", "unfollow")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="speeds[direct]" value="<?php pinav($a, "speeds", "direct")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="speeds[repost]" value="<?php pinav($a, "speeds", "repost")?>">
				</div>
			</div>
		</div>
