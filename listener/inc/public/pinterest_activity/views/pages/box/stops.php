	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="stops[comment]" value="<?php pinav($a, "stops", "comment")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="stops[follow]" value="<?php pinav($a, "stops", "follow")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="stops[unfollow]" value="<?php pinav($a, "stops", "unfollow")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="stops[direct]" value="<?php pinav($a, "stops", "direct")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<input type="number" class="form-control action-save" name="stops[repost]" value="<?php pinav($a, "stops", "repost")?>">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="ig-ac-option wrap-m">
				<div class="info wrap-c">
					...
					<i class="fa fa-question-circle" data-toggle="tooltip-custom" data-trigger="hover" data-placement="top" data-html="true" title="" data-original-title="<?php _e("Format: HH:MM. For example, if you set it to <b>01:00</b>, then your activity will stop automatically after one hour. If you leave it empty, then activity will work infinite or while Pinterest limits for your account not will be reached.", false)?>"></i>
				</div>
				<div class="action wrap-c">
					<input type="text" class="form-control action-save" name="stops[timer]" placeholder="00:00" value="<?php pinav($a, "stops", "timer")?>">
				</div>
			</div>
		</div>
			...
			<div class="ig-ac-option wrap-m">
				...
				<div class="action wrap-c">
					<select class="form-control action-save" name="stops[no_activity]">
  					<option <?php pinav($a, "stops", "no_activity", "no") ?> value="no"><?php _e("Never")?></option>
  					<option <?php pinav($a, "stops", "no_activity", "1h") ?> value="1h"><?php _e("1 hour")?></option>
					<option <?php pinav($a, "stops", "no_activity", "3h") ?> value="3h"><?php _e("3 hours")?></option>
					<option <?php pinav($a, "stops", "no_activity", "12h") ?> value="12h"><?php _e("12 hours")?></option>
					<option <?php pinav($a, "stops", "no_activity", "1d") ?> value="1d"><?php _e("1 day")?></option>
					<option <?php pinav($a, "stops", "no_activity", "3d") ?> value="3d"><?php _e("3 days")?></option>
					<option <?php pinav($a, "stops", "no_activity", "1w") ?> value="1w"><?php _e("1 Week")?></option>
  				</select>
				</div>
			</div>
		</div>
