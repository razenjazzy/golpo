<?php
class linkedin_pages_model extends MY_Model {
	...
	public function block_accounts($path = ""){
		if( get_option('linkedin_page_status', 1) ){
			$dir = get_directory_block(__DIR__, get_class($this));
			$team_id = _t('id');
			$result = $this->main_model->fetch('*', $this->tb_account_manager, "social_network = 'linkedin' AND category = 'page' AND team_id = '".$team_id."'");
			return [
				'position' => 600,
				'id' => $this->module_id,
