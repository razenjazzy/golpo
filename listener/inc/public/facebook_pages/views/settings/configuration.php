...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="facebook_page_permissions" name="facebook_page_permissions" value="<?php _e( get_option('facebook_page_permissions', 'pages_read_engagement,pages_manage_posts') )?>">
</div>