<?php
class pinterest_boards_model extends MY_Model {
	...
	public function block_accounts($path = ""){
		...
		$team_id = _t('id');
		$result = $this->main_model->fetch('*', $this->tb_account_manager, "social_network = 'pinterest' AND category = 'board' AND team_id = '".$team_id."'");
		return [
			'position' => 650,
			'id' => $this->module_id,
