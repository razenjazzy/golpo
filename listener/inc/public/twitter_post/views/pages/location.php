			    ...
			    <div class="widget-item widget-item-3 search-list">
				 	<a href="#">
		                ...
		                <div class="content content-2">
		                    <div class="title fw-4"><?php _e($row->full_name)?></div>
		                    <div class="desc"><?php _e($row->country)?></div>
		                </div>
		            </a>
					<div class="widget-option">
						<label class="i-radio i-radio--tick i-radio--brand m-t-6">
							<input type="radio" name="advance[location]" class="check-item" value="<?php _e($row->id)?>">
							<span></span>
						</label>
					</div>
				</div>
