            ...
            <script type="text/javascript">
            	$(function(){
	    			setTimeout(function(){
	    				Core.pieChart(
		    				"chart-area",
		    				["<?php _e('Photo')?>", "<?php _e('Video')?>", "<?php _e('Link')?>", "<?php _e('Text')?>"], 
		    				[
		    					<?php _e( _gt($module_name."_photo_count", 0) )?>,
		    					<?php _e( _gt($module_name."_video_count", 0) )?>,
		    					<?php _e( _gt($module_name."_link_count", 0) )?>,
		    					<?php _e( _gt($module_name."_text_count", 0) )?>
		    				]
		    			);
	    			}, 300);
	    		});
