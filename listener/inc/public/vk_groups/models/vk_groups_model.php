<?php
class vk_groups_model extends MY_Model {
	...
	public function block_accounts($path = ""){
		...
		$team_id = _t('id');
		$result = $this->main_model->fetch('*', $this->tb_account_manager, "social_network = 'vk' AND category = 'group' AND team_id = '".$team_id."'");
		return [
			'position' => 1400,
			'id' => $this->module_id,
