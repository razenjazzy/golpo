<section class="activity-post mb-xlg">
    <form method="get" action="/">
        <textarea name="message-text" id="msg" data-plugin-textarea-autosize="" placeholder="{$_L['Add Activity']}..." rows="1" style="overflow: hidden; word-wrap: break-word; resize: none; height: 100px;"></textarea>
    ...
    <div class="compose-box-footer">
        ...
        <ul class="compose-btn">
            <li>
                ...
                <a class="btn btn-primary btn-xs" id="acf-post">{$_L['Post']}</a>
            </li>
        </ul>
    </div>
</section>
    ...
    <div class="timeline-item">
        <div class="row">
            ...
            <div class="col-xs-9 content no-top-border">
                ...
                <p>{$acs['msg']}</p>
                <p><a href="{$_url}contacts/activity-delete/{$acs['cid']}/{$acs['id']}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> {$_L['Delete']}</a> </p>
